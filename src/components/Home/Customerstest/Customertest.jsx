...
const Customertest = () => {
  const elements = [
  {
      ...
      title: "Dependability is what comes to mind when I think about Lydian. His deep domain knowledge of Demand planning & forecasting which entailed preparing detailed selection criteria (software & hardware) to choose the most suitable forecasting tool for Glenmark’s India Formulation Business. ",
      name:"Sohil Sanghvi",
  ...
  },
  {
      ...
      title: "I worked with Lydian on the SAP ECC, APO and EWM implementation for Abdul Latif Jameel in Saudi Arabia. Lok was part of our team as the Service Provider responsible for the implementation of the solution, responsible for the implementation of APO.",
  ...
  
  {
      ...
      title: "Lydian has been very helpful not only in bringing his expertise to our group but in making sure that he transfers that expertise to the team. He is a delight to work with given his positive attitude and professionalism. ",
      name:"Teh Opinion",
