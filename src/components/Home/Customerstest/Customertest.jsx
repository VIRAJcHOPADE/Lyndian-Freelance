...
const Customertest = () => {
  const elements = [
  {
      ...
      title: "Dependability is what comes to mind when I think about Loknath Rao. His deep domain knowledge of Demand planning & forecasting which entailed preparing detailed selection criteria (software & hardware) to choose the most suitable forecasting tool for Glenmark’s India Formulation Business. ",
      name:"Sohil Sanghvi",
  ...
  },
  {
      ...
      title: "I worked with Loknath on the SAP ECC, APO and EWM implementation for Abdul Latif Jameel in Saudi Arabia. Lok was part of our team as the Service Provider responsible for the implementation of the solution, responsible for the implementation of APO.",
    ...
    
  {
      ...
      title: "During this time Loknath worked on secondment in the role of SAP APO Solution Architect. He was a pleasure to work with and showed a high skill level in implementing SAP APO. He has a cheerful manner and shows a high degree of flexibility often working long hours to ensure complete client satisfaction.",
      name:"Graeme Mclean",
  ...
  },
  {
      ...
      title:
      "Lok is an an excellent SCM consultant I have ever met. Even though, it was a short stint, I enjoyed working with LOK to investigate the possibilities of tools and solutions to recommend the best suited software for Production Planning. ",
...

  {
      ...
      title:
      "Loknath Rao joined Adaniwilmar as logistic officer in the year 2000. in fact I still remember him as a person who had a job in a Dairy industry but wanted a job in Logistic. It is passion for this profession that led him into it. During his tenure I have always found him a person who had a holistic approach to supply chain management.",
      name:"Biplab Pakrashi",
      position:"Leader • Learner • Strategist • Executioner || S&OP • GTM • SCM ",
  },
  
  {
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQUELL2iTMsxkbPaMrAKaxl4cHbbF80CsKek4lGOzlR6A&s",
      title: "Loknath has been very helpful not only in bringing his expertise to our group but in making sure that he transfers that expertise to the team. He is a delight to work with given his positive attitude and professionalism. ",
      name:"Teh Opinion",
        ...
        <div class="costumercard">
          ...
          <img src={ele.image}></img>
            <div class="cardContent">
              <h3>{ele.name}
            <br></br><span>{ele.position}</span></h3>
            </div>    
          </div>
          <p>{ele.title}</p>      
        </div>
