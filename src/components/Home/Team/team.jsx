...
const teamMembers = [
  {
    name: 'Loknath Rao',
    image: 'Picture1.jpg',
    description: 'Philippines, India Supply Chain Planning, Scheduling, and Analytics = SAP SCM, IBP, BW, S4 ERP',
    linkedin: 'https://www.linkedin.com/in/loknathrao/',
  },
  {
    name: 'Nitin Thatte',
    image: 'Picture2.jpg',
    description: 'India Supply Network Optimizer – Logistics Specialist, Modeler, Supply Chain Engineer',
    linkedin: 'https://www.linkedin.com/in/nitin-thatte-a616888/',
  },
  {
    name: 'Denis Myagkov',
    image: 'Picture3.jpg',
    description: 'Germany Software Architect, Model Builder, Data Engineer - Supply Chain, Finance',
